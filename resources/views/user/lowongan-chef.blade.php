    ...
    <div class="card-custom">
        <div class="job-card flex-column align-items-start position-relative">
            ...
            <div class="job-left w-100 mb-3">
                ...
                <div class="text1">
                    <small class="fw-semibold">WE’RE HIRING — CHEF</small><br>
                    <small>
                    ...
                    <p class="mt-2 mb-0" style="font-size:13px; max-width:900px;">
                        SL Corp membuka lowongan untuk posisi Chef bagi individu yang memiliki passion di bidang kuliner
                        dan mampu bekerja secara profesional dalam tim dapur...
                    </p>
                </div>
            </div>
            ...
            <div style="font-size:13px; line-height:1.6;">
                ...
                <p class="fw-semibold mb-1">Alasan Dibukanya Lowongan Koki (Chef)</p>
                <p>
                    Pembukaan lowongan Koki (Chef) dilakukan untuk memenuhi kebutuhan operasional dapur di Outlet SL Corp Purwokerto yang terus berkembang.
                    Seiring meningkatnya jumlah pelanggan dan variasi menu, SL Corp membutuhkan tenaga Chef tambahan untuk menjaga kualitas rasa,
                    konsistensi penyajian, serta kebersihan dapur.
                    Penambahan Chef bertujuan agar proses produksi makanan berjalan lebih efektif, higienis, dan sesuai dengan standar SL Corp.
                </p>

                <p class="fw-semibold mb-1">Tujuan Penempatan</p>
                <p>
                    Posisi Chef ini dibuka khusus untuk mengisi kebutuhan tenaga kerja di Outlet SL Corp Purwokerto guna mendukung aktivitas operasional harian
                    dan peningkatan kualitas layanan.
                </p>

                <p class="fw-semibold mb-1">Persyaratan Pendaftaran Chef</p>
                <ol>
                    ...
                    <li>Memiliki pengalaman di bidang dapur/F&amp;B menjadi nilai tambah (tidak wajib)</li>
                </ol>
